...
export default function ResumePreview({ data }) {
  if (!data.name) return <div className="p-4 bg-gray-100 text-center">No preview yet. Save your resume first.</div>;
  return (
    <div className="bg-white p-6 rounded shadow print:p-0 print:shadow-none print:rounded-none">
...
export default function ResumePreview({ data }) {
  ...
  return (
    <div className="bg-white px-8 rounded shadow print:p-0 print:shadow-none print:rounded-none print:text-black">
      <h2  align="center" className="text-2xl font-bold">{data.name}</h2>

      <address align="center"className="italic text-blue-700 not-italic mt-1">
